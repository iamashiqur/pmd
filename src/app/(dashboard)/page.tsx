...
const Property = () => {
  ...
  return (
    <>
      ...
      <h1 className="mb-4 text-2xl font-bold">Property Management Dashboard</h1>
      <CheckInCheckOut checkIns={5} checkOuts={3} />
      <PropertyFilters filters={filters} onFilterChange={handleFilterChange} />
      <PropertyList properties={filteredProperties} />
      <AddPropertyForm form={form} onFormChange={setForm} onAddProperty={handleAddProperty} errors={errors} />
    </>
  )
}
